...
\hypersetup{colorlinks=true,linkcolor=paperlink,citecolor=paperlink,urlcolor=paperlink,
  pdfborder={0 0 0},pdftitle={Cache the Encoder Within: Reusing Intermediate Representations across LLM Queries},pdfauthor={Anonymous}}
\newcommand{\writepass}{\textsc{Write}}
\newcommand{\selectpass}{\textsc{Select}}
\newcommand{\readpass}{\textsc{Read}}
\newcommand{\midcache}{MidCache}
...
\title{Cache the Encoder Within:\\Reusing Intermediate Representations\\across LLM Queries}
...
\input{sections/09_diagnostics}
\input{sections/10_benchmarks}
\input{sections/11_systems}
\input{sections/12_statistics}
