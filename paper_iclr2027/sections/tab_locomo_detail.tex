...
\bottomrule
\end{tabular}
\caption{LoCoMo on all 1,986 no-chat examples. Judge 1--4 covers 1,540 answerable items; full Judge incorporates the 446 locally scored abstention items. Substring denotes lexical accuracy. $^\dagger$Different backbone. The no-chat CoMem/KV-Direct semantic ordering is not preserved under native chat formatting. $^{\ddagger}$HCache-style uses a retrieval-free checkpoint distinct from the same-split adapter diagnostic.}
