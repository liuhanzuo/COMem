...
\item \textbf{A semantic-encoder cache.} CoMem turns lower-layer document representations into persistent memory and reuses them through the decoder's own upper layers.
