...
\bottomrule
\end{tabular}
\caption{Hy3 readout on matched 16-document PG-19 windows. PPL ratio is CoMem-readout perplexity divided by full-context perplexity; top-1 is argmax agreement. Training uses rank-32 LoRA, $\alpha=64$, suffix layers 32 onward, and 4,000 plain-PG-19 distillation steps.}
\label{tab:hy3}
\end{table}
