...
\input{sections/tab_matched_detail}
...
\label{sec:overlap}
\input{sections/tab_context}
\input{sections/tab_overlap}
...
\input{sections/tab_overlap_confirmation}
...
\input{sections/tab_frozen_depth}
\input{sections/tab_multidepth}
\input{sections/tab_adapter_detail}
...
\input{sections/tab_selector_detail}
\input{sections/tab_dense_retrieval}
\input{sections/tab_attention_chunk}
