...
\midrule
MidCache & single-2 & 100 & 100 & 99 & 99 & 100 \\
 & multikey & 95 & 94 & 97 & 91 & 93 \\
 & tracking & 96.6 & 97.6 & 98.8 & 99.0 & 95.8 \\
\midrule
MidCache (without LoRA) & single-2 & 27.0 & 46.0 & 48.0 & 54.0 & 41.0 \\
...
\bottomrule
\end{tabular}
\caption{Both MidCache variants use $j=12$. RULER Cohort A: 100 examples per cell, official scorer, and no chat template. The single-needle variant is single-2 for the cohort despite abbreviated labels. MidCache macro is 97.05. KV-Direct uses native RoPE without YaRN. $^\dagger$MemoryLLM uses a different chat-tuned backbone. $^{\ddagger}$HCache-style uses a retrieval-free checkpoint distinct from the same-split adapter diagnostic.}
\label{tab:ruler-a}
\end{table}
